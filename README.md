...
개인 정상 입력(뉴스 크롤링 결과, Top10 리스트 등 익명화된 표준 샘플)이 아직 파일로 준비되지 않아, 2강 "입·출력 규격 검증 → 반복 시험" 연습은 **강의 공통 샘플(가상 회의 메모 자동화)** 로 먼저 진행합니다. `01-input/`, `02-reference/`, `03-output/`, `tests/lesson-02-results.md`를 확인하세요. 이 공통 샘플의 결과는 만조리서치 자동화의 완료 증거가 아닙니다.
